...
class Preferences {
  ...
  static Settings get settings {
    String? settingsString = pref.getString("ND_SETTINGS");
  ...
  static SideBarEntity get sideBar {
    String? sideBarString = pref.getString("ND_SIDEBAR");
    if (sideBarString != null) {
      return sideBarEntityFromJson(sideBarString);
    } else {
      return SideBarEntity();
    }
  }

  static set sideBar(SideBarEntity sideBar) {
    pref.setString("ND_SIDEBAR", sideBarEntityToJson(sideBar));
  }
}
